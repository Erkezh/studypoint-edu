    ...
    <nav class="container mx-auto px-4 py-3">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-6 absolute left-1/2 transform -translate-x-1/2">
          ...
          <router-link
            v-if="authStore.isAuthenticated && userGradeLevel"
          ...
          <span
            v-else-if="authStore.isAuthenticated && !userGradeLevel"
            class="text-white opacity-50 cursor-not-allowed font-medium"
            title="Сынып көрсетілмеген"
          >
            Оқу
          </span>
          <router-link
        ...
        <div class="flex items-center gap-3">
          ...
          <div v-if="authStore.isAuthenticated" class="relative">
            <button
              ...
              style="background-color: #2d8a00;"
              onmouseover="this.style.backgroundColor='#338000'"
          ...
          <div v-else class="flex items-center gap-2">
            ...
            <router-link to="/auth/register">
              <Button variant="primary" class="text-white border" style="background-color: #2d8a00; border-color: #2d8a00;" onmouseover="this.style.backgroundColor='#338000'; this.style.borderColor='#338000'" onmouseout="this.style.backgroundColor='#2d8a00'; this.style.borderColor='#2d8a00'">Тіркелу</Button>
            </router-link>
          </div>
        </div>
      </div>
