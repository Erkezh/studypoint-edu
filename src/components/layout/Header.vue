    ...
    <nav class="container mx-auto px-4 py-3">
      <div class="flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-6 absolute left-1/2 transform -translate-x-1/2">
          ...
          <template v-else>
            ...
            <router-link v-if="authStore.user?.role === 'TEACHER'"
              to="/teacher" class="text-white hover:text-gray-100 transition-colors font-medium flex items-center gap-2"
      ...
      <div v-if="showMobileMenu" class="md:hidden mt-4 pb-2 border-t border-white/20 pt-4 space-y-2">
        ...
        <template v-else>
          ...
          <router-link v-if="authStore.user?.role === 'TEACHER'" to="/teacher" @click="showMobileMenu = false"
            class="block px-3 py-2 text-white hover:bg-white/10 rounded-lg transition-colors font-medium">
            Мұғалім кабинеті
          </router-link>
