      ...
      <div class="p-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
        <div class="relative">
          ...
          <input
            ...
            class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-64 lg:w-80 transition-shadow"
          >
        </div>
        <span class="text-sm text-gray-500 font-medium">Барлығы: {{ filteredUsers.length }}</span>
      </div>
